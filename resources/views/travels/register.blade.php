...
<head>
    ...
    <title>Travel_record アカウント作成画面</title>
</head>
        ...
        <div class="login-box">
            <form action="{{ route('register') }}" method="post" class="login-form">
                ...
                <div class="login-h-box">
                    ...
                    <h3 class="login-h3">アカウント作成</h3>
                </div>
                <div class="form-group">
                    <label for="name">ユーザー名</label>
                    <input type="text" name="name" id="name" class="form-control" placeholder="Username" value="{{ old('name') }}" autocomplete="username">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" id="email" class="form-control" aria-describedby="emailHelp" placeholder="Enter email" value="{{ old('email') }}" autocomplete="email">
